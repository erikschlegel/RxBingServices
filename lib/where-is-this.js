...
const serviceUrl = "http://dev.virtualearth.net/REST/v1/Locations/{0},{1}?inclnb=1&o=json&key={2}&$format=json&jsonp=JSONPCallback";
...
export function whereAmI(input, exits){
