...
var defaultCoordinates = '42.362606,-71.087918';

var whereAmIObs = _rx2['default'].DOM.geolocation.getCurrentPosition();
...
var subscription = whereAmIObs.subscribe(function (pos) {
  ...
  var coordSplit = defaultCoordinates.split(',');
...
},{"./whats-around-me":4,"./where-is-this":5}],4:[function(require,module,exports){
'use strict';
...
},{"./data/entityTypes.json":2,"./index":3,"extend":7,"rx":10,"rx-dom":9}],5:[function(require,module,exports){
'use strict';
...
var serviceUrl = "http://dev.virtualearth.net/REST/v1/Locations/{0},{1}?&o=json&key={2}&$format=json&jsonp=JSONPCallback";
...
require('./dist/rx.dom');
module.exports = Rx;
},{"./dist/rx.dom":8,"rx":10}],10:[function(require,module,exports){
